...
namespace CmsLibrary.DataAccess.CostMonitoring {
    public class ProjectsMainSqlConnector : IProjectsMainConnection {

        public void CreateMainProject( ProjectsMainModel credentials , string events , string tableName ) {
        ...
        public void UpdateMainProject( ProjectsMainModel credentials ) {
